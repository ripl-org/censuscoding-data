### CA: City and County of San Fransisco - Enterprise Addressing System
...
Filename: `Address_APN.csv`

Website: [https://sdgis-sandag.opendata.arcgis.com/datasets/SANDAG::address-apn-1](https://sdgis-sandag.opendata.arcgis.com/datasets/SANDAG::address-apn-1)

License:
> Data is generalized and created for use in regional projects. Please refer to SanGIS data end user use agreement and disclaimer which is available at the following: http://www.sangis.org/Legal_Notice.htm. The address layer is not expected to be a complete inventory of every address in the County. Data is available only as provided to SanGIS. Addresses are SITUS address points - not structure or owner or mailing addresses. Apartment addresses are not included. Most condominium and mobile home addresses are not resolved to the actual structure location.

### CA: County of Santa Clara - Open Data Portal - AddressPoint
...
Filename: `AddressPoint_data.csv`
...
### IL: Cook County - Open Data - Assessor - Property Locations
...
Filename: `Assessor__Archived_05-11-2022__-_Property_Locations.csv`
...
Website: [https://data.lojic.org/datasets/jefferson-county-ky-address-points/explore](https://data.lojic.org/datasets/jefferson-county-ky-address-points/explore)

License: [LOJIC Open Data Terms and Conditions Statement](https://www.lojic.org/data/liability-statement)

### MI: City of Detroit - Open Data Portal - Base Unit Address Points
...
Filename: `Base_Units_Address_Points.csv`

Website: [https://data.detroitmi.gov/datasets/base-units-address-points/explore](https://data.detroitmi.gov/datasets/base-units-address-points/explore)

License: [Open Data Portal Disclaimer](https://data.detroitmi.gov/pages/disclaimer)
...
License: [Nebraska Use Policy - Use of Site Information](https://www.nebraska.gov/policies/)

### PA: City of Philadelphia - OpenDataPhilly - Philadelphia Properties and Assessment History
...
Website: [https://www.opendataphilly.org/dataset/opa-property-assessments](https://www.opendataphilly.org/dataset/opa-property-assessments)
...
Filename: `Addresses_in_King_County___address_point.csv`
